...
| tertiary  | Hellblau     | #86bbd8 | 219 254 135 | <span style="display:block; width:30%; background-color:#86bbd8; border:1px solid #000; aspect-ratio:1/1;"></span>         |
...
::: {.callout-tip title="Farbwerte-Konfiguration (CSV) für CollectionBuilder" icon="false" collapse="true"}
```{.html}
color_class,color
primary,#3a1e3e
secondary,#ffe880
...
Für die zehn Bände der Stadt.Geschichte.Basel hat das Team für Forschungsdatenmanagement rund 120 Grafiken -- hauptsächlich [Karten](../../research-data/geodata/index.qmd) und [Diagramme](../../research-data/plots/index.qmd) -- bearbeitet bzw. erstellt. In Bezug auf die farbliche Gestaltung bestand neben den bereits genannten Anforderungen zusätzlich noch der Anspruch, eine über alle Bücher hinweg erkennbar zusammenhängende Formensprache zu finden. Dies stellte sich jedoch u.a. aufgrund der Vielzahl an Abbildungstypen (Landkarten, Balkendiagramme, Netzwerkvisualisierungen, etc.), wegen fachspezifisch unterschiedlicher Konventionen zum Einsatz wissenschaftlicher Visualisierungen oder wegen fachlich bedingter Differenzen in Genauigkeit und Vollständigkeit von Grundlagendaten als schwieriges Unterfangen dar.
...
Als Grundlage für die Gestaltung der wissenschaftlichen Abbildungen für die Printprodukte von Stadt.Geschichte.Basel wurde eine Farbpalette -- in zwei Varianten, mit je 23 bzw. 14 Farben -- ausgewählt. Das [Discrete Rainbow Colour Scheme 19](https://sronpersonalpages.nl/~pault/#fig:scheme_rainbow_discrete) ist für Farbenblinde "reasonably clear" [@tol_sequential_2022], sofern die Farbwerte nicht interpoliert werden. Für die [Grafikerstellung in R](../../research-data/plots/index.qmd) ist die Palette auch im Package khroma [verfügbar](https://packages.tesselle.org/khroma/articles/tol.html#rainbow) [@frerebeau_paul_2025].
...
: Farbpalette für Printprodukte mit 23 Farben [@tol_sequential_2022] {#tbl-sgbprint23 .hover .sm .col-centered}

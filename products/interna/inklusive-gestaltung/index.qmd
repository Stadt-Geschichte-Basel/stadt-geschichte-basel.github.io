...
Inklusives Design zielt darauf ab, Inhalte und Dienstleistungen für alle Menschen zugänglich und nutzbar zu machen, unabhängig von ihren individuellen Fähigkeiten oder Einschränkungen. Ausgangspunkt für die Implementierung stellt der [Web Content Accessibility Standard (WCAG) 2.1](https://www.w3.org/WAI/standards-guidelines/wcag/glance/) dar. Konkret sind das die WCAG-Guidelines, die mit den Begriffen Wahrnehmbarkeit, Bedienbarkeit, Verständlichkeit und Robustheit kategorisiert werden. Durch die Anwendung dieser Prinzipien wird sichergestellt, dass Webseiten barrierefrei gestaltet sind.

### **WCAG 2.1 A/AA-Checklist**

Auf Basis der [Schweizer Accessibility-Checkliste 2.1](https://a11y.digitaldialog.swiss/de/163)[^1], erarbeitet von [Zugang für alle -- Kompetenzzentrum und Schweizer Zertifizierungsstelle für digitale Barrierefreiheit](https://access-for-all.ch/)

[^1]: Grundlage ist eine Vorabversion der Checkliste, abgerufen am 10.03.2025. Laut Beschreibung von *Zugang für alle* sind die Inhalte und Erfolgskriterien bereits vollständig erhalten, noch ausgebaut werden jedoch noch Navigationsmöglichkeiten und Verknüpfungen für die Inhalte auf der [a11y.check-Webseite](https://a11y.digitaldialog.swiss/de/163).

Hier: Vorlage für Markdown, Verlinkung auf Auswertung für Portal und Plattform.
**Additional context**
* https://a11y.digitaldialog.swiss/de/checklist
* https://www.w3.org/WAI/ARIA/apg/patterns/
* https://www.ech.ch/de/ech/ech-0059/3.0
* https://collectionbuilder.github.io/cb-docs/docs/accessibility/
* https://developer.chrome.com/docs/lighthouse/accessibility/scoring

::: {.callout-tip title="Checklist-Vorlage (Markdown) anzeigen" icon="false" collapse="true"}

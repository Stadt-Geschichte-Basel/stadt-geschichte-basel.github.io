...
Unsere Inhalte in Blog und sozialen Netzwerken sollen für möglichst viele Menschen zugänglich sein. Deshalb achten wir auf eine verständliche Sprache, die Vermeidung von Fachjargon, alternative Textbeschreibungen für Bilder sowie eine lesefreundliche Formatierung. Zudem stellen wir sicher, dass Videos möglichst mit Untertiteln versehen sind und Verlinkungen eindeutig beschrieben werden.

Die Richtlinien von Stadt.Geschichte.Basel für den Blog und die sozialen Medien betonen wissenschaftliche Genauigkeit, Respekt und Inklusion. Sie fördern eine korrekte Darstellung historischer Fakten, transparente Quellenangaben und einen respektvollen, faktenbasierten Diskurs. Diskriminierung jeglicher Art wird nicht toleriert, und es wird auf geschlechtergerechte Sprache sowie Barrierefreiheit geachtet. Der Schutz personenbezogener Daten hat Priorität, wobei Daten nur mit Zustimmung erhoben und sicher aufbewahrt werden. Die Rechte Dritter werden respektiert, und unangemessene Inhalte wie Spam oder vulgäre Sprache sind untersagt. Ein Moderationsteam überwacht die Einhaltung dieser Richtlinien und ergreift bei Verstößen entsprechende Maßnahmen. Für Blog-Beiträge gelten spezifische formale Anforderungen, darunter Titel- und Textlängen, Kategorien, historische Perioden, Bildnutzung mit entsprechenden Quellenangaben und Barrierefreiheitshinweisen. 

Unsere vollständigen Richtlinien zur Veröffentlichung von Inhalten finden Sie [hier](https://stadtgeschichtebasel.ch/richtlinien-fuer-den-blog-und-soziale-medien).

## Printprodukte

Die vom Team für Forschungsdatenmanagement erstellten Abbildungen für die Printausgabe von Stadt.Geschichte.Basel sind [Karten](../../research-data/geodata/index.qmd) sowie [Diagramme](../../research-data/plots/index.qmd). Auch für diese Abbildungen gilt das Ziel, Barrierefreiheit und Zugänglichkeit in Bild- und Formensprache zu verankern. Noch stärker als im Kontext der Online-Angebote musste hier Rücksicht auf gestalterische und drucktechnische Vorgaben seitens des Verlags und der Buchgestalter\*innen genommen werden.
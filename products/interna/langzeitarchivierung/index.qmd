---
title: Dokumentation: Langzeitarchivierungsstrategie (LZA)
category: Interna
author: 
    - name: Moritz Mähr
...
* **Zugang:** [DOI 10.5281/zenodo.15681536](https://doi.org/10.5281/zenodo.15681536)
...
* **Zugang:** [SWH Directory](https://archive.softwareheritage.org/browse/origin/directory/?origin_url=https://doi.org/10.5281/zenodo.15681536)
...
* **Abdeckung:** Portal, Forschungsdatenplattform und Dokumentation.
* **Status:** [Siehe Detail-Dokumentation zu e-Helvetica](/interna/langzeitarchivierung-ehelvetica)
...
* **Plattform:** **EMono** (Repository der Universität Basel) & Zenodo.
...
* **Intern:** Der Redaktionsprozess und CMS-Details sind separat dokumentiert (siehe `products/interna/blog-cms/index.qmd`).
...
2.  **Technische & Inhaltliche Dokumentation:** Diese Plattform (`dokumentation.stadtgeschichtebasel.ch`) wird technisch wie Software behandelt. Sie liegt als statische Seite vor, deren Quelltext und Inhalt (Markdown) via GitHub und Zenodo archiviert wird. Dies stellt sicher, dass auch die Anleitungen, Konzepte und Entscheidungswege (wie in diesem Wiki) dauerhaft lesbar bleiben.

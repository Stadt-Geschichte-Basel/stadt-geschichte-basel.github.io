...
Die Forschungsdatenplattform wurde anhand der [Schweizer Accessibility-Checkliste](../../interna/inklusive-gestaltung/index.qmd) auf die Erfüllung des WCAG-Standards in der Version 2.1 geprüft.

::: {.callout-tip title="Accessibility-Checkliste (Forschungsdatenplattform) anzeigen" icon="false" collapse="true"}

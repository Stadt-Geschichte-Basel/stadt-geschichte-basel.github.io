...
Das Metadatenschema für MEDIA-Objekte wurde um das Feld `dcterms:abstract` erweitert, das zur Erfassung von Alt-Attributen (alternative Textbeschreibungen) für Barrierefreiheit dient. Dieses Feld ermöglicht es, beschreibenden Text für Bilder und andere visuelle Medien zu hinterlegen, der von Screenreadern und anderen assistiven Technologien verwendet werden kann.
...
direction LR
    ...
    class media {
        ...
        description
        [abstract] (alt attribute for accessibility)
